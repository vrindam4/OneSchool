    ...
    <div class="col-sm-3 sidenav">
      ...
      <div style="padding-top: 50px;">
          <ul class="nav nav-pills nav-stacked">
            ...
            <li class="active"><a href="student_exam_before.php">Exams</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div style="text-align: center;" class="card-body">
                                <h3 class="card-title">Select Test</h3>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th style="padding-left: 75px;" class="border-top-0">TEACHER NAME</th>
                                            <th class="border-top-0">TEST NAME</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        while($res=mysqli_fetch_array($result)){
                                            ...
                                            $teacher_uname = $res['uname'];
                                            $test = preg_split("/\_/", $testname1);
                                            $result1 = mysqli_query($con, "SELECT * from login where uname ='$teacher_uname'");
                                            while ($res1 = mysqli_fetch_array($result1)) {
                                            	$teacher_name = $res1["name"];
                                            }
                                            ?>
                                            <tr>
                                              <td><?php echo $teacher_name; ?></td>
                                              <td>
                                              	<a href="student_exam.php?a=<?php echo $testname1?>">
                                              	<?php echo $test[2] ?>
                                              	</a>
                                              </td> 
                                            </tr>
