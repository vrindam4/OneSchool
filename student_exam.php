<?php
  ...
  $query ="select * from student where uname='$uname' and test_name='$testname'";
  $query_run = mysqli_query($con,$query);
  if(mysqli_num_rows($query_run)){
    //test already taken
    echo '<script type ="text/javascript"> alert("Test Taken")</script>';
    echo "<script>location.href='student_exam_before.php'</script>";
  }
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div style="text-align: center;" class="card-body">
                                <h2 class="card-title"><?php echo $test ?></h2>
                            </div>
                            ...
                            <?php
                              if(isset($_POST['submit'])){
                                ...
                                // $uname = $_SESSION['username'];
                                $query = "INSERT into student values('$uname','$testname','$Score')";
                                $query_run = mysqli_query($con,$query);
